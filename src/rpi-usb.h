...
static_assert(sizeof(usb_device_descriptor) == 0x12, "usb_device_descriptor must be 18 bytes long");
...
static_assert(sizeof(usb_configuration_descriptor) == 9, "usb_configuration_descriptor must be 9 bytes long");
