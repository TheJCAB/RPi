...
{{
    ...
    L1GpuMem(0x8000'0000),          //   0xC000'0000 -   0xFFFF'FFFF: (unused)
    {},                             // 0x1'0000'0000 - 0x1'3FFF'FFFF: (unused)
    {},                             // 0x1'4000'0000 - 0x1'7FFF'FFFF: (unused)
    {},                             // 0x1'8000'0000 - 0x1'BFFF'FFFF: (unused)
    {},                             // 0x1'C000'0000 - 0x1'FFFF'FFFF: (unused)
    ...
    {},                             // 0x4'8000'0000 - 0x4'BFFF'FFFF: (unused)
    {},                             // 0x4'C000'0000 - 0x4'FFFF'FFFF: (unused)
    L1DeviceMem(0x40'0000'0000ull), // 0x5'0000'0000 - 0x5'3FFF'FFFF: (unused)
    {},                             // 0x5'4000'0000 - 0x5'7FFF'FFFF: (unused)
    L1DeviceMem(0x00'8000'0000ull), // 0x5'8000'0000 - 0x5'BFFF'FFFF: (unused)
    {},                             // 0x5'C000'0000 - 0x5'FFFF'FFFF: (unused)
    L1DeviceMem(0x80'0000'0000ull), // 0x6'0000'0000 - 0x6'3FFF'FFFF: (unused)
    L1DeviceMem(0x80'4000'0000ull), // 0x6'4000'0000 - 0x6'7FFF'FFFF: (unused)
    L1DeviceMem(0x80'8000'0000ull), // 0x6'8000'0000 - 0x6'BFFF'FFFF: (unused)
    L1DeviceMem(0x80'C000'0000ull), // 0x6'C000'0000 - 0x6'FFFF'FFFF: (unused)
